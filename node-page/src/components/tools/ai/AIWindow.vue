<template>
  ...
  >
    ...
    <div
      ...
      class="message-wrap"
      v-loading="currentSession.loading"
      :class="{editable: getEditable(currentSession)}"
    >
      <ul class="message-list" @scroll="handleScroll(false)" @scrollend="handleScrollEnd">
...
<!--            </ul>-->
          ...
          <div class="message-content">
            ...
            <pre v-else-if="message.self">{{message.currentText}}</pre>
            <MarkdownEditor
              v-else
